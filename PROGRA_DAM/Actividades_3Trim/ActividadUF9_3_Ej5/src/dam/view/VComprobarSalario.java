...
public class VComprobarSalario extends JFrame {
	private JTextField textNumero;
	private JButton btnComprobar;
	private JLabel lblResultado;
	private JLabel lblEuros;
	public VComprobarSalario() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		JLabel lblIntro = new JLabel("HORAS");
		...
		btnComprobar = new JButton("CALCULAR SALARIO");
